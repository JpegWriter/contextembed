    ...
    try {
      ...
      if (signInError) {
        ...
        if (signUpData.user && !signUpData.session) {
          toast.error('Email confirmation required. Please disable it in Supabase settings.');
          return;
        }
...
NEXT_PUBLIC_SUPABASE_ANON_KEY=your_key`}
  ...
  return (
    <AuthCard
      ...
      subtitle="Start embedding context that travels with every image."
      helperText="Best for photographers, agencies, and AI workflows that need proof."
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <AuthInput
          ...
          required
          minLength={8}
          helperText="Use 8+ characters. A passphrase works great."
